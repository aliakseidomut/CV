  ...
  return (
    <div className="w-2/4 mx-auto">
      ...
      <InfoList
        name={"Experience"}
        items={[
          'Developed numerous projects in JavaScript and TypeScript as part of the "JavaScript/Front-end" course at RS School.',
          "Developed various projects using JavaScript and React as part of my university studies.",
